...
# from routers.cost_estimation_project import router as cost_estimation_project_router
...
# app.include_router(cost_estimation_project_router, prefix="/cost-estimation-projects", tags=["Cost Estimation Projects"])
